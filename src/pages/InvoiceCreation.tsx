...
// import { formatInventoryPhoto } from "./Inventory";
...
// export const formatInvoiceAction = (
...
//         total: inventoryData.price,
//         action: (
//           <div>
//             <Input type="number" min={1} max={qty} defaultValue={1} 
//                   onChange={(e: ChangeEvent<HTMLInputElement>) =>
//                     changeInventoryRemoveQty(parseInt(e.target.value), (inventoryData.id))
//                   } />
//             <Button onClick={()=>removeItemFromInvoiceData(inventoryData.id)}>Remove</Button>
//           </div>
//         ),
//       }
